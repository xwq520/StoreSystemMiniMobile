  ...
  children: [
    {
      ...
      name: 'ordereditor',
      component(resolve) {
        require.ensure(['./components/ordereditor/ordereditor.vue'], () => {
          resolve(require('./components/ordereditor/ordereditor.vue'));
        });
      }
    }, {
      path: '/orderplay',
      name: 'orderplay',
      component(resolve) {
        require.ensure(['./components/orderplay/orderplay.vue'], () => {
          resolve(require('./components/orderplay/orderplay.vue'));
        });
      }
    }
  ]
